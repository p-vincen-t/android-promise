...
public class Base64 {
   ...
   * cannot be serialized or there is another withErrorCallback,
   ...
   * @throws java.io.IOException  if there is an withErrorCallback
   ...
   *
   *
   * <p>As of v 2.3, if there is an withErrorCallback with the GZIP stream,
   * the method will throw an java.io.IOException. <b>This is new to v2.3!</b>
   * In earlier versions, it just returned a null value, but
   * in retrospect that's a pretty poor way to handle it.</p>
   *
   ...
   * Does not GZip-compress data.
   *
   * <p>As of v 2.3, if there is an withErrorCallback,
   * the method will throw an java.io.IOException. <b>This is new to v2.3!</b>
   * In earlier versions, it just returned a null value, but
   * in retrospect that's a pretty poor way to handle it.</p>
   *
  ...
  private static int decode4to3(
    ...
    // Lots of withErrorCallback checking and exception throwing
    if (source == null) {
...
// end while: reading input
          ...
          // No withErrorCallback? Get new bytes.
   ...
   * Object within. Returns <tt>null</tt> if there was an withErrorCallback.
   *
   * @param encodedObject The Base64 data to decode
   * @return The decoded and deserialized object
   * @throws NullPointerException   if encodedObject is null
   * @throws java.io.IOException    if there is a general withErrorCallback
...
// end else: no custom class loader
   ...
   *
   * <p>As of v 2.3, if there is a withErrorCallback,
   * the method will throw an java.io.IOException. <b>This is new to v2.3!</b>
...
// end while
  ...
  public static class OutputStream extends java.io.FilterOutputStream {
     ...
     *
     * @throws java.io.IOException if there's an withErrorCallback.
     */
     ...
     *
     * @throws java.io.IOException if there's an withErrorCallback flushing
     * @since 1.5.1
     */
