...
package dev4vin.promise.data.net;
...
import dev4vin.promise.data.net.extras.HttpPayload;
import dev4vin.promise.data.net.extras.HttpResponse;
import dev4vin.promise.data.net.extras.InputStreamHttpResponse;
import dev4vin.promise.data.net.extras.Interceptor;
import dev4vin.promise.data.net.extras.JsonHttpResponse;
import dev4vin.promise.data.net.extras.JsonObjectHttpResponse;
...
public class FastParser {
                      ...
                      if (responseInterceptor != null) try {
                        responseInterceptor.intercept(
                            ...
                            new ResponseCallBack<HttpResponse<?, ?>, Throwable>()
                                .withCallback(
                                    httpResponse -> responseCallBack.response(
   ...
   *
   * @param request the request to be executed
   * @return a withCallback from the serve
   * @throws IOException if the server didnt return a withCallback or if theirs no network connection
   */
