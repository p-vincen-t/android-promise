...
/**
 * Adapts a {@link Call} with withCallback type {@code R} into the type of {@code T}. Instances are
...
public interface CallAdapter<R, T> {
  /**
   * Returns the value type that this adapter uses when converting the HTTP withCallback body to a Java
   * object. For example, the withCallback type for {@code Call<Repo>} is {@code Repo}. This type
