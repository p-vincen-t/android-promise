 ...
 * Each extending class must implement {@link Converter#get(Object)} } method to
 * convert the {@link SModel} instance to a content value see {@link ContentValues}
 * and {@link Converter#from(Object)} }
...
public abstract class Model<T extends SModel>
   ...
   */
  private final String ALTER_COMMAND = "ALTER TABLE";
  /**
  ...
  public boolean onUpgrade(SQLiteDatabase database, int v1, int v2) throws ModelError {
    ...
    @SuppressLint("Recycle") Cursor c = database.rawQuery(builder.build(), builder.buildParameters());
   ...
   * @throws ModelError if theirs an sql withErrorCallback
   */
  public final void addColumns(SQLiteDatabase database, Column... columns) throws ModelError {
   ...
   * @throws ModelError if theirs an sql withErrorCallback
   */
  public final boolean dropColumns(SQLiteDatabase database, Column... columns) throws ModelError {
    for (Column column : columns) {
      String alterSql =
   ...
   */
  @Override
  public final Table.Extras<T> read(final SQLiteDatabase database) {
   ...
   */
  @Override
  public final SList<? extends T> onReadAll(SQLiteDatabase database, Column[] columns) {
   ...
   */
  @Override
  public final boolean onUpdate(T t, SQLiteDatabase database) {
    try {
   ...
   */
  @Override
  public final <C> boolean onDelete(SQLiteDatabase database, Column<? extends C> column, List<? extends C> list) {
    boolean deleted;
    String where = "";
   ...
   */
  @Override
  public final boolean onDelete(T t, SQLiteDatabase database) {
  ...
  /**
   * backup all the items in the table during dangerous upgrades
   * @param database readable database instance
   */
  @Override
  public void backup(SQLiteDatabase database) {
    if (backup == null) backup = new SList<>();
   ...
   * see {@link Converter} for serializing and de-serializing
   * @param <Q> The type of the items in the table
   */
  private abstract class QueryExtras<Q extends SModel>
      implements Table.Extras<Q>, Converter<Q, Cursor, ContentValues> {
    /**
     ...
     */
    @Override
    public <N extends Number> SList<? extends Q> between(Column<? extends N> column, N a, N b) {
      Cursor cursor;
      try {
    ...
    @SafeVarargs
    @Override
    public final <N extends Number> SList<? extends Q> notIn(Column<? extends N> column, N... bounds) {
      Cursor cursor;
